(() => {
  ...
  const INDEX_DIMENSION_CARDS = {
    'zh-Hans': [
      ...
      { title: '15｜特质符号解读', desc: '从贵人、文昌、驿马、华盖等传统符号视角，补充解读你的性格特点与倾向。' },
    ...
    'zh-Hant': [
      ...
      { title: '15｜特質符號解讀', desc: '從貴人、文昌、驛馬、華蓋等傳統符號視角，補充解讀你的性格特點與傾向。' },
  ...
  const INDEX_TEXT = {
    ...
    payTitle: { 'zh-Hans': '解锁完整深度性格分析报告', 'zh-Hant': '解鎖完整深度性格分析報告', en: 'Unlock Full In-depth Personality Report' },
    paySub: {
      'zh-Hans': '免费版仅含基础排盘，完整报告涵盖 24 大性格维度 · 深度解析约 7000-9000 字',
      'zh-Hant': '免費版僅含基礎排盤，完整報告涵蓋 24 大性格維度 · 深度解析約 7000-9000 字',
      en: 'Free tier includes basic chart only. Full report covers 24 personality dimensions · around 7,000-9,000 Chinese characters',
    },
    payFeatures: {
      'zh-Hans': [
        '▸ 性格核心：五行核心力量 / 平衡结构 / 性格驱动力 / 天赋优势',
        '▸ 适合方向：适合的工作风格 / 价值创造方式 / 擅长领域 / 独立与协作倾向',
        '▸ 关系相处：情感相处倾向 / 相处说明书 / 亲密关系中的自我模式',
        '▸ 家庭人际：原生家庭影响 / 家庭角色倾向 / 人际互动风格',
        '▸ 特质结构：特质符号解读 / 内在张力结构 / 空缺感 / 资源与安全感倾向',
        '▸ 成长节奏：不同阶段的性格侧重 · 成长节奏参考',
        '▸ 自我成长：需要留意的性格盲点 / 关键成长课题 / 自我提升建议 / 核心课题总结',
      ],
      'zh-Hant': [
        '▸ 性格核心：五行核心力量 / 平衡結構 / 性格驅動力 / 天賦優勢',
        '▸ 適合方向：適合的工作風格 / 價值創造方式 / 擅長領域 / 獨立與協作傾向',
        '▸ 關係相處：情感相處傾向 / 相處說明書 / 親密關係中的自我模式',
        '▸ 家庭人際：原生家庭影響 / 家庭角色傾向 / 人際互動風格',
        '▸ 特質結構：特質符號解讀 / 內在張力結構 / 空缺感 / 資源與安全感傾向',
        '▸ 成長節奏：不同階段的性格側重 · 成長節奏參考',
        '▸ 自我成長：需要留意的性格盲點 / 關鍵成長課題 / 自我提升建議 / 核心課題總結',
      ],
      en: [
        '▸ Core traits: dominant element force / balance / personality driver / talent profile',
        '▸ Suitable directions: work-style fit / value-creation style / suitable fields / solo vs. team',
        '▸ Relationships: relating tendencies / relationship manual / patterns you bring to closeness',
        '▸ Family & social: family-of-origin impact / family role style / social style',
        '▸ Trait structure: symbolic traits / inner tension map / inner gaps / resource & security attitude',
        '▸ Growth rhythm: traits amplified at each life stage · growth-theme reference',
        '▸ Self-growth: blind spots to watch / key growth themes / self-improvement tips / life core theme',
      ],
    },
    consultPayBtn: {
  ...
  const HEPAN_TEXT = {
    ...
    payChip3: { 'zh-Hans': '相处风格', 'zh-Hant': '相處風格', en: 'Relating Style' },
    ...
    payFeatures: {
      ...
      en: [
        '▸ Two personalities · complementary or draining to each other',
        '▸ Five-element complement · who energizes whom, who gets drained',
        '▸ Relating rhythm · who leads, who follows, communication differences',
        '▸ Emotional needs · what each person cares about most',
        '▸ Values tendencies · differing views on stability, freedom, responsibility',
        '▸ Friction points · sources of conflict and how to ease them',
        '▸ Complementary strengths · where you two work best together',
        '▸ Relationship manual · smoother communication and getting-along tips',
        '▸ Long-term fit · how your personality structures align',
        '▸ Overall assessment & relating advice',
      ],
    },
    marketingCopy: {
      'zh-Hans': '看清两个人的性格适配面：从各自的性格结构到相处风格，给你可执行的沟通与相处建议。原价268元，限时优惠199元。',
      'zh-Hant': '看清兩個人的性格適配面：從各自的性格結構到相處風格，給你可執行的溝通與相處建議。原價268元，限時優惠199元。',
      en: 'Understand how your two personalities fit. From each personality structure to relating style, get practical communication and getting-along advice. Original ¥268, promo ¥199.',
    },
